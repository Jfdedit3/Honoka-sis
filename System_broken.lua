...
if game.CoreGui:FindFirstChild("SysBroker") then
    game:GetService("StarterGui"):SetCore("SendNotification", {Title = "I NEED MY HERO",Text = "",Duration = 5;})
    return
end
local version = 2
--VARIABLES
...
TitleBarLabel.Text = "__/honoka sis\__"
...
SendNotify("System Broken","Gui developed by z4trox",10)
setclipboard("")
